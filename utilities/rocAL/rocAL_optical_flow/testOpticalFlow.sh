...
RESIZE_WIDTH=400    # width with which frames should be resized (applicable only for READER_CASE 2)
RESIZE_HEIGHT=400    # height with which frames should be resized (applicable only for READER_CASE 2)
