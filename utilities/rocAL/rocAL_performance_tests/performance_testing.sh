...
do
   ...
   ;;
   "1") file_name=rocalCropResize.txt
   ;;
   ...
   ;;
   "27") file_name=rocalResizeCropMirror.txt
   ;;
   "28") file_name=No-Op.txt
   ;;
esac
    echo arguments $INPUTPATH $width $height $testcase $batch_size $device $shard_count $shuffle >> ./../output_folder/$file_name
